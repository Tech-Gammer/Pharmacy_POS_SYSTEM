                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Center(child: Text('Product List', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))),
                        Container(
                          decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Sub Total Balance:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        Text('${provider.total.toStringAsFixed(2)}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                        const Text('Apply Discount:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        TextFormField(
                        ...
                        const Text('Total After Discount:', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                        Text('${provider.grandTotal.toStringAsFixed(2)}', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        const Text('Cash Received:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        TextFormField(
                        ...
                        const SizedBox(height: 20),
                        const Text('Grand Total Balance:', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                        Text('${provider.grandTotal.toStringAsFixed(2)}', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        const Text('Remaining Balance:', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                        Text('${provider.remainingbalance.toStringAsFixed(2)}', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                ],
