...
class SalesReportPageManager extends StatefulWidget {
  @override
  _SalesReportPageManagerState createState() => _SalesReportPageManagerState();
}

class _SalesReportPageManagerState extends State<SalesReportPageManager> {
