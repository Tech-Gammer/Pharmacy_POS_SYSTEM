...
import 'package:pharmacy_pos_system/Reports/Sales%20Reports/sale_reportbyitems.dart';
import 'package:pharmacy_pos_system/Reports/Sales%20Reports/sale_reports.dart';
    ...
    return GridView.count(
      ...
      children: [
        ...
        DashboardItem(
          ...
          onButtonPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) =>   SalesReportByItemPage()));
          },
        ),
      ],
    );
